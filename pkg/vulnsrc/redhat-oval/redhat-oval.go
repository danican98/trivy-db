...
import (
	...
	"github.com/danican98/trivy-db/pkg/utils/ints"
	ustrings "github.com/danican98/trivy-db/pkg/utils/strings"
...
func (vs VulnSrc) Get(pkgName string, repositories, nvrs []string) ([]types.Advisory, error) {
	...
	if len(cpeIndices) == 0 {
		return nil, xerrors.Errorf("unable to find CPE indices. See https://github.com/danican98/trivy-db/issues/435 for details")
	}
